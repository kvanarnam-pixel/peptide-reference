...
**NAD+_Compound_Research.md and Retatrutide_Compound_Research.md** (predate the Tier 1 voice-rules lock, added 2026-08-25):
- NAD+'s "What They're Not Telling You" (Tier 1) currently has three inline PMID citations (35010977, 31710095, 32906142) that violate the new voice rules — needs translation to plain English, or the specific claims moved to a bottom-of-section note if they still need flagging as evidence-weight caveats.
- Retatrutide's "What They're Not Telling You" (Tier 1) has one bare "(Bezin et al.)" author mention with no PMID attached — same fix, lower urgency since there's no citation number, just a name.
- Not urgent. Same low-priority tier as the verification-pass and Response-guided-dosing-framework debt already logged above — clean up opportunistically, not a dedicated pass.
