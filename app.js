(() => {
  ...
  const GHKCU_CHIPS = [
    ...
    [
      { key: "watch", label: "Watch for", value: "Copper load", detail: `<p>The sharper long-term question is chronic copper load from repeated injecting — there is no multi-year human safety study on that. Topical has decades of safety history because systemic absorption through skin is minimal; injecting bypasses that margin. Wilson's disease or known copper overload is a hard stop. Feeling better is not the same as tissue fully remodeled and ready for full load.</p>` },
